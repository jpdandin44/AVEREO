...
const LATEST_INITIAL_TARIFS = {
    ...
    // --- EXTRACTIONS BATIPRIX ---
    batiprix_chauffage_mo: { id: "batiprix_chauffage_mo", nom: "BATIPRIX CHAUFFAGE - Main-d'œuvre moyenne", unite: "h", prix_eco: 39.07, prix_std: 45.97, prix_premium: 52.87 },
    batiprix_chauffage_chaudiere: { id: "batiprix_chauffage_chaudiere", nom: "BATIPRIX CHAUFFAGE - Chaudière fonte fioul 16 à 21 kW", unite: "unité", prix_eco: 4056.00, prix_std: 4771.81, prix_premium: 5487.58 },
    batiprix_climatisation_mo: { id: "batiprix_climatisation_mo", nom: "BATIPRIX CLIMATISATION - Main-d'œuvre moyenne", unite: "h", prix_eco: 39.07, prix_std: 45.97, prix_premium: 52.87 },
    batiprix_climatisation_window: { id: "batiprix_climatisation_window", nom: "BATIPRIX CLIMATISATION - Climatiseur window froid seul R32", unite: "unité", prix_eco: 1789.82, prix_std: 2105.68, prix_premium: 2421.53 },
    batiprix_elec_mo: { id: "batiprix_elec_mo", nom: "BATIPRIX ELECTRICITE - Main-d'œuvre moyenne", unite: "h", prix_eco: 37.29, prix_std: 43.88, prix_premium: 50.46 },
    batiprix_elec_fouille: { id: "batiprix_elec_fouille", nom: "BATIPRIX ELECTRICITE - Fouille manuelle en tranchée 0,40x0,60 m", unite: "ml", prix_eco: 27.98, prix_std: 32.92, prix_premium: 37.85 },
    batiprix_etancheite_mo: { id: "batiprix_etancheite_mo", nom: "BATIPRIX ETANCHEITE - Main-d'œuvre moyenne", unite: "h", prix_eco: 43.57, prix_std: 51.26, prix_premium: 58.94 },
    batiprix_plomberie_mo: { id: "batiprix_plomberie_mo", nom: "BATIPRIX PLOMBERIE - Main-d'œuvre moyenne", unite: "h", prix_eco: 39.22, prix_std: 46.15, prix_premium: 53.07 },
    batiprix_plomberie_baignoire: { id: "batiprix_plomberie_baignoire", nom: "BATIPRIX PLOMBERIE - Baignoire en fonte émaillée série éco", unite: "unité", prix_eco: 996.32, prix_std: 1172.15, prix_premium: 1347.97 },
    batiprix_ventilation_mo: { id: "batiprix_ventilation_mo", nom: "BATIPRIX VENTILATION - Main-d'œuvre moyenne", unite: "h", prix_eco: 39.07, prix_std: 45.97, prix_premium: 52.87 },
    batiprix_ventilation_vmc: { id: "batiprix_ventilation_vmc", nom: "BATIPRIX VENTILATION - Kit VMC 1 cuisine 2 sanitaires", unite: "unité", prix_eco: 384.21, prix_std: 452.02, prix_premium: 519.82 },
    batiprix_tce_mo: { id: "batiprix_tce_mo", nom: "BATIPRIX TCE - Main-d'œuvre moyenne", unite: "h", prix_eco: 37.33, prix_std: 43.92, prix_premium: 50.50 }
};
...
const useAppStore = create((set) => ({
    ...
    hydrate: () => {
        try {
            ...
            // On fusionne les tarifs sauvegardés avec les nouveaux tarifs en dur pour s'assurer que les extractions Batiprix s'ajoutent.
            let tarifsToLoad = LATEST_INITIAL_TARIFS;
            if (savedTarifs) {
                tarifsToLoad = { ...LATEST_INITIAL_TARIFS, ...JSON.parse(savedTarifs) };
            }
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                <div className="space-y-8">
                    ...
                    <div className="bg-white p-6 rounded-xl shadow-sm border">
                           ...
                           {(bien.dossier.attachments || []).map(att => (
                                <div key={att.id} className="flex justify-between items-center p-3 bg-gray-50 rounded-md">
                                   <div className="flex items-center space-x-3 overflow-hidden">
                                       ...
                                       <span className="text-sm text-gray-800 truncate" title={att.name}>{att.name}</span>
                                   </div>
                        ...
                        <button onClick={() => fileInputRef.current.click()} className="w-full flex justify-center items-center py-2 px-4 border border-dashed border-gray-300 rounded-md text-sm font-medium text-gray-700 hover:bg-gray-50">
                            <UploadIcon />
                            Ajouter un fichier
                        </button>
                    </div>
